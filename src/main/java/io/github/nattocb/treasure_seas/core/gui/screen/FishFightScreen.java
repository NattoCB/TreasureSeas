...
import io.github.nattocb.treasure_seas.core.eventsubscriber.client.MouseEventHandler;
import io.github.nattocb.treasure_seas.core.packet.FishFightResultPacket;
...
import io.github.nattocb.treasure_seas.core.utility.WaveGenerator;
...
@OnlyIn(Dist.CLIENT)
public class FishFightScreen extends Screen {
    ...
    public FishFightScreen(Component titleIn, Vec3 bobberPos, FishWrapper fishWrapper) {
        super(titleIn);
